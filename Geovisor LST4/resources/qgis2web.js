...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32718',
            //extent: [499196.814416, 8583393.892955, 566708.352146, 8626899.390888],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([499196.814416, 8583393.892955, 566708.352146, 8626899.390888], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Geovisor LST4</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (142 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Usted se encuentra en un Geovisor del proyecto Longitudinal de la Sierra Tramo 4 a cargo de la Dirección de Disponibilidad de Predios del MTC.';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_ComunidadesCampesinas_1,
    colName: 'COMUNIDAD',
    zoom: 10,
    collapsed: true,
    map: map,
