...
lyr_ComunidadesCampesinas_1.set('fieldAliases', {'N°_EXP': 'Expediente:', 'CODIGO': 'Codigo de Predio:', 'ESTAD_AVAN': 'Estado Situacional:', 'FORMA_ADQ': 'Forma de Adquisición:', 'NOM_TITU': 'Titular:', 'COMUNIDAD': 'Nombre de Comunidad:', 'AREA_AFEC': 'Area Afectada (m2):', 'TECNICO_EX': 'Tecnico Encargado:', 'LEGAL_EXP': 'Legal Encargado:', });
lyr_MatricesPrivados_2.set('fieldAliases', {'N°_EXP': 'Expediente:', 'CODIGO': 'Codigo de Predio:', 'ESTAD_AVAN': 'Estado Situacional:', 'FORMA_ADQ': 'Forma de Adquisición:', 'MONTO_TOTA': 'Monto Total:', 'NOM_TITU': 'Titular:', 'AREA_AFEC': 'Area Afectada (m2):', 'TECNICO_EX': 'Tecnico Encargado:', 'LEGAL_EXP': 'Legal Encargado:', });
lyr_Areasafectadas_3.set('fieldAliases', {'CODIGO': 'Codigo de Predio:', 'N°_EXP': 'Expediente:', 'ESTAD_AVAN': 'Estado Situacional:', 'FORMA_ADQ': 'Forma de Adquisición:', 'MONTO_TOTA': 'Monto Total:', 'NOM_TITU': 'Titular:', 'AREA_AFEC': 'Area Afectada (m2):', 'TECNICO_EX': 'Tecnico Encargado:', 'LEGAL_EXP': 'Legal Encargado:', });
...
lyr_Derechodevia_7.set('fieldAliases', {'Id': 'Id', 'nombre': 'nombre', 'SUBTRAMO': 'SUBTRAMO', 'Area (ha)': 'Area (ha)', 'Per (km)': 'Per (km)', });
lyr_Progresivas_8.set('fieldAliases', {'P_text': 'Progresivas', 'PROGRESIVA': 'Num', });
...
lyr_Derechodevia_7.set('fieldImages', {'Id': 'Range', 'nombre': 'TextEdit', 'SUBTRAMO': 'TextEdit', 'Area (ha)': '', 'Per (km)': '', });
...
lyr_INTER_PUNTO_6.set('fieldLabels', {'TITULAR': 'inline label - always visible', 'TIPO_INT': 'inline label - always visible', 'DESC_ELEM': 'header label - visible with data', 'TIPO_CONV': 'hidden field', 'EST_ACT': 'hidden field', 'ITEM': 'hidden field', 'EST_LIB': 'hidden field', 'ETELI': 'hidden field', });
lyr_Derechodevia_7.set('fieldLabels', {'Id': 'hidden field', 'nombre': 'hidden field', 'SUBTRAMO': 'inline label - always visible', 'Area (ha)': 'inline label - always visible', 'Per (km)': 'inline label - always visible', });
