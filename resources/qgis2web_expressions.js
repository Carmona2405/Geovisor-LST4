...
function exp_label_ComunidadesCampesinas_1_eval_expression(context) {
    // COMUNIDAD || '\n' || ESTAD_AVAN || '\n' || N°_EXP

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((feature.get('COMUNIDAD')  + '\n') + feature.get('ESTAD_AVAN') ) + '\n') + feature.get('N°_EXP') );
    } else {
        return ((((feature.get('COMUNIDAD')  + '\n') + feature.get('ESTAD_AVAN') ) + '\n') + feature.get('N°_EXP') );
    }
}
...
function exp_label_INTER_LINEA_5_eval_expression(context) {
    // TIPO_INT || '\n' || TITULAR || '\n' || DESC_ELEM

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((feature.get('TIPO_INT')  + '\n') + feature.get('TITULAR') ) + '\n') + feature.get('DESC_ELEM') );
    } else {
        return ((((feature.get('TIPO_INT')  + '\n') + feature.get('TITULAR') ) + '\n') + feature.get('DESC_ELEM') );
    }
}
...
function exp_label_INTER_PUNTO_6_eval_expression(context) {
    // TIPO_INT || '\n' || TITULAR || '\n' || DESC_ELEM
